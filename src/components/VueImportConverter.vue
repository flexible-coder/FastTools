<template>
  <n-card class="fast-tools-vue-import" :bordered="false" size="small">
    <template #title>
      <div class="fast-tools-vue-import__title">Vue Import 转换</div>
    </template>

    <n-space class="fast-tools-vue-import__body" vertical :size="12">
      <n-input
        ref="inputRef"
        v-model:value="inputValue"
        type="textarea"
        class="fast-tools-vue-import__textarea"
        placeholder="请输入 Vue 文件路径，例如：src\views\business\warehouse\components\export-modal\index.vue"
      ...
      <div class="fast-tools-vue-import__output-head">
        <span>转换结果</span>
      ...
      <n-input
        ...
        type="textarea"
        class="fast-tools-vue-import__textarea fast-tools-vue-import__textarea--output"
        readonly
...
.fast-tools-vue-import__body {
  width: 100%;
}

.fast-tools-vue-import__textarea {
  color: #1b2328;
...
.fast-tools-vue-import__textarea :deep(textarea) {
  font-family: inherit;
  font-size: 13px;
  line-height: 1.55;
  resize: vertical;
...
.fast-tools-vue-import__textarea--output :deep(.n-input-wrapper) {
  background: #f7fafc;
}

.fast-tools-vue-import__output-head {
  display: flex;
  align-items: center;
